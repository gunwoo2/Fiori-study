					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flexible 컬럼 레이아웃 연습(눈에 보이는 제목)",
									"targetURL": "#synceafcl-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synceafcl-display": {
								"semanticObject": "synceafcl",
								"action": "display",
								"description": "개발자만 볼 수 있는 내부 설명",
								"title": "Flexible 컬럼 레이아웃 연습(눈에 보이는 제목)",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.ea.fcl",
									"url": sap.ui.require.toUrl("sync/ea/fcl")
								}
							}
						}
					}
