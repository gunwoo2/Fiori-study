		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON 모델 연습",
									"targetURL": "#synce03jsonmodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03jsonmodel-display": {
								"semanticObject": "synce03jsonmodel",
								"action": "display",
								"description": "JSON 모델 연습하",
								"title": "JSON 모델 연습",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.jsonmodel",
									"url": sap.ui.require.toUrl("sync/e03/jsonmodel")
								}
							}
						}
					}
