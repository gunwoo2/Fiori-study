		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "다중 데이터 삭제",
									"targetURL": "#synce03odatamodelmultidelete-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03odatamodelmultidelete-display": {
								"semanticObject": "synce03odatamodelmultidelete",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.odatamodelmultidelete",
									"url": sap.ui.require.toUrl("sync/e03/odatamodelmultidelete")
								}
							}
						}
					}
