		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Create and Use Fragments",
									"targetURL": "#synce03exercise8-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03exercise8-display": {
								"semanticObject": "synce03exercise8",
								"action": "display",
								"description": "UX400의 연습문",
								"title": "Create and Use Fragments",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.exercise8",
									"url": sap.ui.require.toUrl("sync/e03/exercise8")
								}
							}
						}
					}
