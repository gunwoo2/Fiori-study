		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제리뷰 e03",
									"targetURL": "#synce03ex2reiew-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03ex2reiew-display": {
								"semanticObject": "synce03ex2reiew",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.ex2reiew",
									"url": sap.ui.require.toUrl("sync/e03/ex2reiew")
								}
							}
						}
					}
