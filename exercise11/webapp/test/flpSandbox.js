		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Use Element Binding &amp; Association",
									"targetURL": "#synce03exercise11-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03exercise11-display": {
								"semanticObject": "synce03exercise11",
								"action": "display",
								"description": "항공사와 항공편 조회",
								"title": "Use Element Binding &amp; Association",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.exercise11",
									"url": sap.ui.require.toUrl("sync/e03/exercise11")
								}
							}
						}
					}
