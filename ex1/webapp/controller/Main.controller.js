sap.ui.define([
    ...
    function (Controller, JSONModel) {
        ...
        return Controller.extend("sync.e03.ex1.controller.Main", {
            onInit: function () {
                let data = {
                    value1: 0,
                    value2: 0,
            ...
            checkInput1: function(oEvent) {
                var sValue = oEvent.getSource().getValue();
                if (!sValue) {
                    oEvent.getSource().setValueState("Error");
                    oEvent.getSource().setValueStateText("필수 입력 필드입니다.");
                } else {
