					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제 E03",
									"targetURL": "#synce03ex1-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce03ex1-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.ex1",
									"url": sap.ui.require.toUrl("sync/e03/ex1")
								}
							}
						}
					}
