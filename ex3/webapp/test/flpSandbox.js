					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제 E03",
									"targetURL": "#synce03ex3-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce03ex3-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.ex3",
									"url": sap.ui.require.toUrl("sync/e03/ex3")
								}
							}
						}
					}
