		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "입력필드의 값 다뤄보기",
									"targetURL": "#synce03input-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03input-display": {
								"semanticObject": "synce03input",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.input",
									"url": sap.ui.require.toUrl("sync/e03/input")
								}
							}
						}
					}
