		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5-Table &amp; Fragment 활용하기",
									"targetURL": "#synce03homework1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03homework1-display": {
								"semanticObject": "synce03homework1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.homework1",
									"url": sap.ui.require.toUrl("sync/e03/homework1")
								}
							}
						}
					}
