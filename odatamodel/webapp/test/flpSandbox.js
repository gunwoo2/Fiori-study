		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "oData 모델의 CRUD",
									"targetURL": "#synce03odatamodel-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03odatamodel-display": {
								"semanticObject": "synce03odatamodel",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.odatamodel",
									"url": sap.ui.require.toUrl("sync/e03/odatamodel")
								}
							}
						}
					}
