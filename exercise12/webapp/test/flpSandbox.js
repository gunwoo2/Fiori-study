		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ue Data Types and Input Validation",
									"targetURL": "#synce03exercise12-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03exercise12-display": {
								"semanticObject": "synce03exercise12",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.exercise12",
									"url": sap.ui.require.toUrl("sync/e03/exercise12")
								}
							}
						}
					}
