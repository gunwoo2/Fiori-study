		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 1번 문제리뷰 E03",
									"targetURL": "#synce03ux1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03ux1review-display": {
								"semanticObject": "synce03ux1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.ux1review",
									"url": sap.ui.require.toUrl("sync/e03/ux1review")
								}
							}
						}
					}
