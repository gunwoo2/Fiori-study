		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#synce03exercise10-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03exercise10-display": {
								"semanticObject": "synce03exercise10",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.exercise10",
									"url": sap.ui.require.toUrl("sync/e03/exercise10")
								}
							}
						}
					}
