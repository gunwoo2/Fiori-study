		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "OData 모델을 통해 다중 데이터 변경",
									"targetURL": "#synce03odatamodelmultiupdate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03odatamodelmultiupdate-display": {
								"semanticObject": "synce03odatamodelmultiupdate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.odatamodelmultiupdate",
									"url": sap.ui.require.toUrl("sync/e03/odatamodelmultiupdate")
								}
							}
						}
					}
