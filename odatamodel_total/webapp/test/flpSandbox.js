		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CRUD 및 다중 Update, Delete",
									"targetURL": "#synce03odatamodeltotal-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03odatamodeltotal-display": {
								"semanticObject": "synce03odatamodeltotal",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.odatamodeltotal",
									"url": sap.ui.require.toUrl("sync/e03/odatamodeltotal")
								}
							}
						}
					}
