		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UI5 - Table &amp; Fragent 활용하기",
									"targetURL": "#synce03hw1review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03hw1review-display": {
								"semanticObject": "synce03hw1review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.hw1review",
									"url": sap.ui.require.toUrl("sync/e03/hw1review")
								}
							}
						}
					}
