		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Binding에서 다양하게 사용해보기",
									"targetURL": "#synce03exercise13-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03exercise13-display": {
								"semanticObject": "synce03exercise13",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.exercise13",
									"url": sap.ui.require.toUrl("sync/e03/exercise13")
								}
							}
						}
					}
