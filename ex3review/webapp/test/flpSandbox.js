		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 3번 문제리뷰 e03",
									"targetURL": "#synce03ex3review-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03ex3review-display": {
								"semanticObject": "synce03ex3review",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.ex3review",
									"url": sap.ui.require.toUrl("sync/e03/ex3review")
								}
							}
						}
					}
