		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "사칙연산 계산기 구현하기",
									"targetURL": "#synce03calculator-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synce03calculator-display": {
								"semanticObject": "synce03calculator",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.calculator",
									"url": sap.ui.require.toUrl("sync/e03/calculator")
								}
							}
						}
					}
