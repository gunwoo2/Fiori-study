					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 4번 문제 e03",
									"targetURL": "#synce03ex4-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce03ex4-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.ex4",
									"url": sap.ui.require.toUrl("sync/e03/ex4")
								}
							}
						}
					}
