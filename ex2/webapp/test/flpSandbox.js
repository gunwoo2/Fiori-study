					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "실습평가 2번 문제 E03",
									"targetURL": "#synce03ex2-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"synce03ex2-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.e03.ex2",
									"url": sap.ui.require.toUrl("sync/e03/ex2")
								}
							}
						}
					}
